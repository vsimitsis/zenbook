        ...
        <div class="col-sm-6">
            <div class="input-group">
                ...
                <textarea type="text" id="qa_question" name="qa_question"
                          class="form-control {{ $errors->has('qa_question') ? 'is-invalid' : '' }}" placeholder="{{ __('rules.question') }}">{{ old('qa_question', $module->examinable ? $module->examinable->question : '') }}</textarea>
        ...
        <div class="col-sm-6">
            <div class="input-group">
                ...
                <input type="number" id="max_answer_length" name="max_answer_length" min="0"
                       ...
                       value="{{ old('max_answer_length', $module->examinable ? $module->examinable->max_answer_length : '') }}" placeholder="{{ __('rules.max_answer_length') }}">
