    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <div class="input-group">
                ...
                <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ old('name', $customer->name) }}" placeholder="Enter full name">
            ...
            <div class="input-group">
                ...
                <select name="timezone" class="form-control {{ $errors->has('timezone') ? 'is-invalid' : '' }}">
                    ...
                    @foreach($timezones as $timezone)
                        <option value="{{ $timezone->id }}" {{ old('timezone', $customer->timezone_id) == $timezone->id ? 'selected' : '' }}>
                            {{ $timezone->name }}
                        </option>
                    @endforeach
                </select>
    ...
    <div class="k-repeater">
        <div class="k-repeater__data-set">
            <div data-repeater-list="contact-list">
                ...
                @include('customers.partials._customer-form-populate-contacts')
            </div>
        </div>
    ...
    <div class="k-repeater">
        <div class="k-repeater__data-set">
            <div data-repeater-list="address-list">
                ...
                @include('customers.partials._customer-form-populate-addresses')
            </div>
        </div>
        <div class="k-repeater__add-data">
	        <span data-repeater-create="" class="btn btn-outline-info btn-sm">
