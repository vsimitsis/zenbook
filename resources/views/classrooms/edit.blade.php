...
@section('title', __('actions.edit_classroom'))
@section('breadcrumbs')
    <div class="k-content__head-breadcrumbs">
        ...
        <span class="k-content__head-breadcrumb-separator"></span>
        <span class="k-content__head-breadcrumb-link k-content__head-breadcrumb-link--active">{{ __('actions.edit_classroom') }}</span>
    </div>
@endsection

@section('content')
    <form id="document_form" action="{{ route('classroom.update', $classroom) }}" class="k-form" method="POST">
        {{ method_field('PUT') }}
        <div class="k-portlet k-portlet--mobile">
            <div class="k-portlet__head k-portlet__head--lg">
                <div class="k-portlet__head-label">
                    <h3 class="k-portlet__head-title">{{ __('actions.edit_classroom') }}</h3>
                </div>
