...
@section('title', __('actions.add_document'))
@section('breadcrumbs')
    <div class="k-content__head-breadcrumbs">
        ...
        <span class="k-content__head-breadcrumb-separator"></span>
        <span class="k-content__head-breadcrumb-link k-content__head-breadcrumb-link--active">{{ __('actions.add_document') }}</span>
    </div>
@endsection

@section('content')
    <form id="document_form" action="{{ route('document.store') }}" class="k-form" method="POST" enctype="multipart/form-data">
        <div class="k-portlet k-portlet--mobile">
            <div class="k-portlet__head k-portlet__head--lg">
                <div class="k-portlet__head-label">
                    <h3 class="k-portlet__head-title">{{ __('actions.add_document') }}</h3>
                </div>
