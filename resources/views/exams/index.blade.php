...
@section('breadcrumbs')
    <div class="k-content__head-breadcrumbs">
        ...
        <span class="k-content__head-breadcrumb-link k-content__head-breadcrumb-link--active">{{ __('models.exams') }}</span>
    </div>
@endsection
    ...
    <div class="k-portlet k-portlet--mobile">
        <div class="k-portlet__head k-portlet__head--lg">
            <div class="k-portlet__head-label">
                <h3 class="k-portlet__head-title">{{ __('models.exams') }}</h3>
            </div>
                                    ...
                                    <td>
                                        @can('edit', $exam)
                                            <form action="{{ route('exam.destroy', $exam) }}" method="POST">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
                                                <a href="{{ route('exam.view', $exam) }}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="{{ __('actions.view') }}">
                                                    <i class="la la-eye"></i>
                                                </a>
                                                ...
                                                <span class="dropdown">
                                                    ...
                                                    <span class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="{{ route('exam.edit', $exam) }}"><i class="la la-edit"></i> {{ __('actions.edit') }}</a>
